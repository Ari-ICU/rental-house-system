                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    ...
                    <div className="relative flex-1 sm:w-64">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-3 py-2 border border-slate-300 dark:border-slate-700 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-sm bg-white dark:bg-slate-900 dark:text-slate-100 hover:border-slate-400 dark:hover:border-slate-600 transition-colors placeholder-slate-400 dark:placeholder-slate-500 text-slate-900 shadow-sm"
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {onBackup && (
                            <button
                                onClick={onBackup}
                                className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 px-4 py-2 rounded-md hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-sm font-medium shadow-sm whitespace-nowrap"
