                ...
                <>
                    ...
                    <div className="p-6 sm:p-10 space-y-6 sm:space-y-8 overflow-y-auto">
                        ...
                        <div className="flex gap-4 pt-6">
                            <button
                                onClick={onClose}
                                className="w-full bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-600 dark:text-gray-300 py-4 px-6 rounded-2xl font-bold text-sm transition-all active:scale-95 whitespace-nowrap"
                            >
