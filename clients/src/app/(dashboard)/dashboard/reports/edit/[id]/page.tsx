...
const EditReportPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchReport = async () => {
            try {
                ...
                // Extract YYYY-MM-DD from the returned dates if they exist
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            setSubmitting(true);
            await reportService.updateReport(parseInt(id, 10), {
                name,
                type,
                    ...
                    <div className="p-8 sm:p-12">
                        <div className="flex flex-col gap-2 mb-10">
                            <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">
                                {lang === 'km' ? 'កែប្រែរបាយការណ៍' : 'Edit Report'}
                            </h1>
                            <p className="text-gray-500 dark:text-gray-400 font-medium">
                                {lang === 'km' ? 'ធ្វើបច្ចុប្បន្នភាពព័ត៌មានលម្អិតនៃរបាយការណ៍អាជីវកម្មនេះ' : 'Update details for this business report'}
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-bold text-gray-400 dark:text-gray-400 uppercase tracking-widest px-1 flex items-center gap-2">
